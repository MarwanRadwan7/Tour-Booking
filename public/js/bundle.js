...
})(
  {
    ...
    zIVT: [
      function (require, module, exports) {
          ...
          x = (e) => {
            return (
              ...
              (('function' == typeof FormData && e instanceof FormData) ||
                ...
                (d(e.toString) && '[object FormData]' === e.toString()))
            );
          },
          P = l('URLSearchParams'),
          B = (e) =>
        ...
        const N = (e, t, n, { allOwnKeys: o } = {}) => (
            v(
              t,
              (t, o) => {
                n && d(t) ? (e[o] = (0, r.default)(t, n)) : (e[o] = t);
              },
              { allOwnKeys: o }
            ),
            e
    ...
    q82J: [
      function (require, module, exports) {
        ...
        function d(i, d, c) {
          ...
          const b = (c = t.default.toFlatObject(
              c,
          ...
          function h(r) {
            ...
            if (!m && t.default.isBlob(r))
              throw new n.default(
                'Blob is not supported. Use a Buffer instead.'
              );
            return t.default.isArrayBuffer(r) || t.default.isTypedArray(r)
          ...
          function w(e, n, r) {
            ...
            if (e && !r && 'object' == typeof e)
              if (t.default.endsWith(n, '{}'))
                (n = b ? n : n.slice(0, -2)), (e = JSON.stringify(e));
              else if (
                (t.default.isArray(e) && a(e)) ||
                t.default.isFileList(e) ||
                (t.default.endsWith(n, '[]') && (i = t.default.toArray(e)))
              )
                return (
                  (n = o(n)),
              ...
              if (!t.default.isUndefined(n)) {
                ...
                B.push(n),
                  t.default.forEach(n, function (n, i) {
                    !0 ===
                      (!(t.default.isUndefined(n) || null === n) &&
                        p.call(
                          d,
                          n,
    ...
    idoZ: [
      function (require, module, exports) {
        ...
        Object.defineProperty(exports, '__esModule', { value: !0 }),
          (exports.default = void 0);
        var e = t(require('./classes/URLSearchParams.js')),
          r = t(require('./classes/FormData.js'));
        function t(e) {
          return e && e.__esModule ? e : { default: e };
        }
        const o = (() => {
    ...
    LYEs: [
      function (require, module, exports) {
        ...
        var e = p(require('./../utils.js')),
          ...
          d = p(require('../helpers/parseProtocol.js')),
          i = p(require('../platform/index.js')),
          ...
          function (c) {
            return new Promise(function (p, E) {
              ...
              void 0 === g && h.setContentType(null),
                ...
                R && 'json' !== R && (q.responseType = c.responseType),
              ...
              x && -1 === i.default.protocols.indexOf(x)
                ? E(
                    new u.default(
    ...
    RB6n: [
      function (require, module, exports) {
        ...
        var e = i(require('./../utils.js')),
          ...
          o = i(require('./dispatchRequest.js')),
    ...
    HXpE: [
      function (require, module, exports) {
        ...
        var e = p(require('./utils.js')),
          ...
          a = p(require('./core/Axios.js')),
          t = p(require('./core/mergeConfig.js')),
          l = p(require('./defaults/index.js')),
          u = p(require('./helpers/formDataToJSON.js')),
          s = p(require('./cancel/CanceledError.js')),
          o = p(require('./cancel/CancelToken.js')),
          d = p(require('./cancel/isCancel.js')),
          i = require('./env/data.js'),
          n = p(require('./helpers/toFormData.js')),
          f = p(require('./core/AxiosError.js')),
          c = p(require('./helpers/spread.js')),
          j = p(require('./helpers/isAxiosError.js')),
          q = p(require('./core/AxiosHeaders.js'));
        function p(e) {
          return e && e.__esModule ? e : { default: e };
        }
        function x(l) {
          const u = new a.default(l),
            s = (0, r.default)(a.default.prototype.request, u);
          return (
            e.default.extend(s, a.default.prototype, u, { allOwnKeys: !0 }),
            e.default.extend(s, u, null, { allOwnKeys: !0 }),
            (s.create = function (e) {
              return x((0, t.default)(l, e));
            }),
            s
          );
        }
        const C = x(l.default);
        (C.Axios = a.default),
          (C.CanceledError = s.default),
          (C.CancelToken = o.default),
          (C.isCancel = d.default),
          (C.VERSION = i.VERSION),
          (C.toFormData = n.default),
          (C.AxiosError = f.default),
          (C.Cancel = C.CanceledError),
          (C.all = function (e) {
            return Promise.all(e);
          }),
          (C.spread = c.default),
          (C.isAxiosError = j.default),
          (C.mergeConfig = t.default),
          (C.AxiosHeaders = q.default),
          (C.formToJSON = (r) =>
            (0, u.default)(e.default.isHTMLForm(r) ? new FormData(r) : r)),
          (C.default = C);
        var m = C;
        exports.default = m;
      },
        ...
        function o() {
          ...
          function j(e, r, s, t) {
            var o = r && r.prototype instanceof f ? r : f,
              ...
              u = new _(t || []);
            return i(n, '_invoke', { value: x(e, s, u) }), n;
          }
          function d(e, r, s) {
            try {
              return { type: 'normal', arg: e.call(r, s) };
            } catch (P) {
                  ...
                  return new r(function (o, u) {
                    !(function o(i, n, u, c) {
                      ...
                      if ('throw' !== a.type) {
                        var l = a.arg,
                          j = l.value;
                        return j && 'object' == t(j) && s.call(j, '__await')
            ...
            return function (o, i) {
              ...
              for (s.method = o, s.arg = i; ; ) {
                ...
                if ('next' === s.method) s.sent = s._sent = s.arg;
                  ...
                  if ('suspendedStart' === t) throw ((t = 'completed'), s.arg);
                ...
                if ('normal' === c.type) {
                  if (
                    ((t = s.done ? 'completed' : 'suspendedYield'), c.arg === m)
                  )
                    continue;
                  return { value: c.arg, done: s.done };
                }
                'throw' === c.type &&
                  ((t = 'completed'), (s.method = 'throw'), (s.arg = c.arg));
              }
            };
          }
          function L(e, r) {
          ...
          return (
            ...
            (e.AsyncIterator = w),
            (e.async = function (r, s, t, o, i) {
              void 0 === i && (i = Promise);
              var n = new w(j(r, s, t, o), i);
            ...
            (_.prototype = {
              ...
              finish: function (e) {
                for (var r = this.tryEntries.length - 1; r >= 0; --r) {
                  ...
                  if (s.finallyLoc === e)
                    return this.complete(s.completion, s.afterLoc), k(s), m;
                }
              },
              catch: function (e) {
                for (var r = this.tryEntries.length - 1; r >= 0; --r) {
                  ...
                  for (;;)
                    switch ((s.prev = s.next)) {
                      ...
                      case 7:
                        (s.prev = 7),
                          (s.t0 = s.catch(0)),
                          (0, r.showAlert)('error', s.t0.response.data.message);
                      case 10:
                      case 'end':
                        return s.stop();
                    }
                ...
                function (s) {
                  for (;;)
                    switch ((s.prev = s.next)) {
                      ...
                      case 3:
                        (s.sent.data.status = 'success') && location.reload(!0),
                          (s.next = 10);
                        break;
                      case 7:
                        (s.prev = 7),
        ...
        function o() {
          ...
          function l(t, r, e, n) {
            var o = r && r.prototype instanceof v ? r : v,
              ...
              u = new S(n || []);
            return i(a, '_invoke', { value: E(t, e, u) }), a;
          }
          function h(t, r, e) {
            try {
              return { type: 'normal', arg: t.call(r, e) };
    ...
    Focm: [
      function (require, module, exports) {
        ...
        function o() {
          ...
          var g = Object.getPrototypeOf,
            w = g && g(g(O([])));
          w && w !== e && r.call(w, u) && (m = w);
          var E = (y.prototype = p.prototype = Object.create(m));
          function b(t) {
          ...
          return (
            (v.prototype = y),
            i(E, 'constructor', { value: y, configurable: !0 }),
        ...
        var u = document.querySelector('.form--login'),
          ...
          f = document.querySelector('.form--signup');
        f &&
          f.addEventListener('submit', function (t) {
            ...
            var e = document.getElementById('name').value,
              ...
              i = document.getElementById('passwordConfirm').value;
            (0, r.signup)(e, n, o, i);
          }),
          u &&
      ...
      { './login': 'mnjM', './updateSettings': 'FxPS', './signup': 'BCHI' },
    ],
  },
  {},
  ['Focm'],
